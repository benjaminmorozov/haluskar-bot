...
exports.run = (client, message) => {
  const baseEmbed = new Discord.RichEmbed()
    ...
    .addField('# **Misc**', '2. Celerová Júlia')
    .addField('# **Misc**', '3. Chudík Marko')
    .addField('# **Misc**', '4. Fridmanský Lukáš')
    .addField('# **Misc**', '5. Fábry Ľubomír')
    .addField('# **Misc**', '6. Gancarčík Juraj')
    .addField('# **Misc**', '7. Gonda Peter')
    .addField('# **Misc**', '8. Hanečák Róbert')
